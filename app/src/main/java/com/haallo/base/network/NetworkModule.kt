...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideWristBandInterceptorHeaders(loggedInUserCache: LoggedInUserCache): HaalloInterceptorHeaders {
        return HaalloInterceptorHeaders(loggedInUserCache)
    }
    ...
    fun provideOkHttpClient(
        context: Context,
        haalloInterceptorHeaders: HaalloInterceptorHeaders,
...
//            .authenticator(tokenAuthenticator)
            .addInterceptor(haalloInterceptorHeaders)
