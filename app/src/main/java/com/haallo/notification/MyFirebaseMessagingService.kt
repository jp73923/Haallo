package com.haallo.notification
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotificationData(context: Context?, body: String?, title: String?, p0: RemoteMessage? = null) {
        var intent: Intent? = null
        when {
            p0 == null -> {
                intent = Intent(context, ChatActivity::class.java)
            }
            p0.data["notification_type"] == EnumUtils.NotificationType.AUDIO_CALL_INCOMING.value -> {
            ...
            p0.data["notification_type"] == EnumUtils.NotificationType.VIDEO_CALL_INCOMING.value -> {
            ...
            p0.data["notification_type"] == EnumUtils.NotificationType.GROUP_AUDIO_CALL_INCOMING.value -> {
            ...
            p0.data["notification_type"] == EnumUtils.NotificationType.GROUP_VIDEO_CALL_INCOMING.value -> {
