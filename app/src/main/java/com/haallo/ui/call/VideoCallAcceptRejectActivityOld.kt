...
class VideoCallAcceptRejectActivityOld : OldBaseActivity(), View.OnClickListener {
    ...
    private fun getDataFromIntent() {
        ...
        videoCallDataBase = FirebaseDatabase.getInstance().reference.child("Call").child(channelName!!).child("call_status")
