...
import com.haallo.util.checkPhonePermission
import com.haallo.util.setPic
...
class ChatMessageAdapter(
...
) : ListAdapter<ChatMsgModel, RecyclerView.ViewHolder>(DiffUtilCallBack()) {

    private val REQUEST_ID_PERMISSIONS: Int = 100
    val listPERMISSIONS: Array<String> = arrayOf(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE)
    var searchText = ""
    var audioPlayer = MediaPlayer()
    var progressDialog = ProgressDialog(context)

    class DiffUtilCallBack : DiffUtil.ItemCallback<ChatMsgModel>() {

        override fun areItemsTheSame(oldItem: ChatMsgModel, newItem: ChatMsgModel): Boolean {
            return Intrinsics.areEqual(oldItem as Any, newItem as Any)
        }

        override fun areContentsTheSame(oldItem: ChatMsgModel, newItem: ChatMsgModel): Boolean {
            return Intrinsics.areEqual(oldItem as Any, newItem as Any)
        }
    }
    ...
    inner class ScreenshotHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindScreenshotHolder(model: ChatMsgModel) {
    ...
    inner class EmojiSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindEmojiSenderView(model: ChatMsgModel) {
            ...
            emojis_send.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
    ...
    inner class EmojiReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindEmojiReceiverView(model: ChatMsgModel) {
            val emojis: List<String> = model.message.split(",")
            emojis_receive.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
            ...
            tvTimeReceiveEmoji.text = chatDateTimeUtil.getChatMessageTime(activity, model.timeStamp.toLong())
    ...
    inner class MessageSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindMessageSenderView(model: ChatMsgModel) {
    ...
    inner class MessageReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindMessageReceiverView(model: ChatMsgModel) {
    ...
    inner class ImageSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindImageSenderView(model: ChatMsgModel) {
            /*  if (model.mediaurl.contains("giphy.gif")) {
                  val gifId =
                      model.mediaurl.split("/")[model.mediaurl.split("/").size - 2]
                  itemView.ivChatMsgSendImage.visibility = View.GONE
                  itemView.gifSendView.visibility = View.VISIBLE
                  itemView.gifSendView.setMediaWithId(gifId)
              } else {
                  itemView.ivChatMsgSendImage.visibility = View.VISIBLE
                  itemView.gifSendView.visibility = View.GONE
              }*/
    ...
    inner class ImageReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindImageReceiverView(model: ChatMsgModel) {
            /*if (model.mediaurl.contains("giphy.gif")) {
                itemView.gifReceiveView.visibility = View.VISIBLE
                itemView.ivChatMsgReceiveImage.visibility = View.GONE
                val gifId =
                    model.mediaurl.split("/")[model.mediaurl.split("/").size - 2]

                itemView.gifReceiveView.setMediaWithId(gifId)


            } else {
                itemView.gifReceiveView.visibility = View.GONE
                itemView.ivChatMsgReceiveImage.visibility = View.VISIBLE
            }*/
    ...
    inner class VideoSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindVideoSenderView(model: ChatMsgModel) {
            if (model.mediaurl != "") {
    ...
    inner class VideoReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindVideoReceiverView(model: ChatMsgModel) {
            if (model.content != "") {
                val mediaMetadataRetriever = MediaMetadataRetriever()
                mediaMetadataRetriever.setDataSource(model.content, HashMap<String, String>())
                val bmFrame: Bitmap? = mediaMetadataRetriever.getFrameAtTime(1000) //unit in microsecond
                if (bmFrame != null) {
    ...
    inner class AudioSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindAudioSenderView(model: ChatMsgModel) {
            ...
            val filePath = Environment.getExternalStorageDirectory()
                .toString() + "/" + Environment.DIRECTORY_MUSIC + "/" + model.message /*"${Environment.getExternalStorageDirectory()}/Esteto/Media/Audio/${model.content}"*/
    ...
    inner class AudioReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindAudioReceiverView(chatMsgModel: ChatMsgModel) {
            val messageBean: ChatMsgModel = chatMsgModel

            tvTimeReceiveAudio.text = chatDateTimeUtil.getChatMessageTime(activity, chatMsgModel.timeStamp.toLong())
...
/*
            ...
            itemView.ivAudioDownloadReceiveAudio.setOnClickListener {
                downloadFile(
                    chatMsgModel.mediaurl,
                    chatMsgModel.message
                )
            }
*/
            ivStarReceiveStar.setOnClickListener {
                starAction.onActionDone(chatMsgModel)
            }

            if (chatMsgModel.starmessage == "u_" + SharedPreferenceUtil.getInstance(context).userId)
            ...
            rlMainReceiveAudio.setOnLongClickListener {
                onActionMessage.handleClick(chatMsgModel, false, false)
                return@setOnLongClickListener true
            }
    ...
    inner class PdfSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindPdfSenderView(model: ChatMsgModel) {
    ...
    inner class PdfReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindPdfReceiverView(model: ChatMsgModel) {
    ...
    inner class ContactSenderHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindContactSenderView(model: ChatMsgModel) {
    ...
    inner class ContactReceiverHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindContactReceiverView(model: ChatMsgModel) {
    ...
    fun getItemAtPos(pos: Int): ChatMsgModel? {
        return getItem(pos)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        Intrinsics.checkParameterIsNotNull(holder, "holder")
        val model: ChatMsgModel = getItem(position) ?: return
        when (holder) {
    ...
    interface onMessageClick {
        fun handleClick(chatMsgModel: ChatMsgModel, isLoginUser: Boolean, isCopy: Boolean)
    }

    interface messageAction {
        fun onActionDone(chatMsgModel: ChatMsgModel)
    }
