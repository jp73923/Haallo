...
import com.haallo.util.toLatLng
import com.haallo.util.toLatLngString
...
class PlacesPickerViewModel(context: Context, lifecycleOwner: LifecycleOwner) : ViewModel(),
