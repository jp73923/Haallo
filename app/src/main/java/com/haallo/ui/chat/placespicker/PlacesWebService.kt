...
import com.haallo.R
import com.haallo.ui.chat.placespicker.model.PlacesResponse
import com.haallo.util.getYYYYMMDD
...
//TODO UnComment For Location
    /*companion object {
        operator fun invoke(
        ): PlacesWebService {
            val requestInterceptor = Interceptor { chain ->
                val url = chain.request().url.newBuilder().addQueryParameter("client_id", CLIENT_ID)
                        .addQueryParameter("client_secret", CLIENT_SECRET)
                        .addQueryParameter("v", getYYYYMMDD())
                        .build()
