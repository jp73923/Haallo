package com.haallo.ui.groupinfo
...
import com.haallo.ui.groupinfo.view.GroupInfoParticipantAdapter
import com.haallo.ui.home.HomeActivity
import com.haallo.util.findGroupDateFromTimeStamp
import java.util.*

class GroupInfoActivity : OldBaseActivity() {
    ...
    override fun initView() {
        ...
        firebaseDbHandler.groupRef.child(groupId).addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                binding.rvParticipantList.adapter = GroupInfoParticipantAdapter(this@GroupInfoActivity, membersData)
            }
