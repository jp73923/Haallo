...
class ResetPasswordActivityOld : OldBaseActivity(), View.OnClickListener {
    ...
    private fun checkTheme() {
        if (sharedPreference.nightTheme) {
            binding.rootLayoutResetPassword.setBackgroundColor(ContextCompat.getColor(this, R.color.appNightModeBackground))
    ...
    private fun resetPasswordApi() {
        showLoading()
        signInToHomeViewModel.resetPasswordApi(mobile, binding.etPassword.getString())
    }
}