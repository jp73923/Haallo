...
public class AttachmentView extends RelativeLayout implements View.OnClickListener {
    ...
    public CardView cardViewAttachments;
    public AttachmentClickListener listener;
    public TextView attachmentGif;
    public TextView attachmentDocument;
    public TextView attachmentCamera;
    public TextView attachmentGallery;
    public TextView attachmentAudio;
    public TextView attachmentLocation;
    public TextView attachmentContact;
    public View attachmentBtn;
    public LinearLayout llMain;
    public ImageView ivImage, ivContact, ivGif, ivLocation, ivDocument, ivAudio;
...
//        attachmentCamera = view.findViewById(R.id.attachment_camera);
        attachmentGif = view.findViewById(R.id.attachment_gif);
        ...
        attachmentGif.setOnClickListener(this);
//        attachmentCamera.setOnClickListener(this);
        ...
        if (SharedPreferenceUtil.Companion.getInstance(context).getNightTheme()) {
            llMain.setBackgroundColor(ContextCompat.getColor(context, R.color.black));
            attachmentGallery.setTextColor(ContextCompat.getColor(context, R.color.white));
            attachmentContact.setTextColor(ContextCompat.getColor(context, R.color.white));
            attachmentLocation.setTextColor(ContextCompat.getColor(context, R.color.white));
          //  attachmentGif.setTextColor(ContextCompat.getColor(context, R.color.white));
            attachmentDocument.setTextColor(ContextCompat.getColor(context, R.color.white));
            attachmentAudio.setTextColor(ContextCompat.getColor(context, R.color.white));

            ivImage.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.white)));
            ivContact.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.white)));
            ivLocation.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.white)));
            ivDocument.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.white)));
            ivAudio.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.white)));
           // ivGif.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.white)));
        }
    }
